...
var DocumentService = /** @class */ (function () {
    function DocumentService() {
        var _this = this;
        this.findDocumentById = function (id, userId) { return __awaiter(_this, void 0, void 0, function () {
            var document, sharedDocument;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, document_model_1.Document.findOne({
                            where: (_a = {},
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, document_user_model_1.DocumentUser.findOne({
                                where: {
                                    userId: userId,
                                    documentId: id,
                                },
                    ...
                    case 2:
                        sharedDocument = _b.sent();
                        if (!sharedDocument)
                            return [2 /*return*/, null];
                        document = sharedDocument.document;
                        _b.label = 3;
                    case 3: return [2 /*return*/, document];
                }
            });
        }); };
    }
